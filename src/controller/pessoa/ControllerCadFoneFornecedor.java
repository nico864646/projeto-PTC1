...
public class ControllerCadFoneFornecedor implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        if (event.getSource() == telaCadFoneFornecedor.getjButtonSalvar()) {
            ...
            ControllerBusFoneFornecedor controllerBusFornecedor = new ControllerBusFoneFornecedor(telaBusFornecedor, idFornecedor);
            ...
            if(idFone != 0){
                ...
                foneFornecedor = foneFornecedorService.buscarPorID(idFone);
