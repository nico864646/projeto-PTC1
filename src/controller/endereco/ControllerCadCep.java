...
public class ControllerCadCep implements ActionListener {
    ...
    public void fillComboBox(){
        ...
        cService.buscar().forEach(cidadeAtual -> {
            this.telaCadCep.getjComboBoxCidade().addItem(cidadeAtual.getDescricao());
        });
        bService.buscar().forEach(bairroAtual -> {
            this.telaCadCep.getjComboBoxBairro().addItem(bairroAtual.getDescricao());
        });
    }
}
